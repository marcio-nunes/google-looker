...
In this task, make a copy of a user-defined (created) dashboard and then convert it into a LookML-based dashboard.
...
Push your changes to the Looker Git repository